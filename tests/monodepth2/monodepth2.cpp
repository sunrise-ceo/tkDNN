...
int main(){
    ...
    //layer2
    new tk::dnn::Conv2d(&net,128,3,3,2,2,1,1,encoder_layer2_bin[0],true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    tk::dnn::Layer *bn2 = new tk::dnn::Conv2d(&net,128,3,3,1,1,1,1,encoder_layer2_bin[1],true);
    new tk::dnn::Route(&net,&last,1);
    new tk::dnn::Conv2d(&net,128,1,1,2,2,0,0,encoder_layer2_bin[2], true);
    new tk::dnn::Shortcut(&net,bn2);
    last = new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    new tk::dnn::Conv2d(&net,128,3,3,1,1,1,1,encoder_layer2_bin[3],true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    new tk::dnn::Conv2d(&net,128,3,3,1,1,1,1,encoder_layer2_bin[4],true);
    new tk::dnn::Shortcut(&net,last);
    last = new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    features.push_back(last);
    ...
    //layer3
    new tk::dnn::Conv2d(&net,256,3,3,2,2,1,1,encoder_layer3_bin[0],true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    bn2 = new tk::dnn::Conv2d(&net,256,3,3,1,1,1,1,encoder_layer3_bin[1],true);
    new tk::dnn::Route(&net,&last,1);
    new tk::dnn::Conv2d(&net,256,1,1,2,2,0,0,encoder_layer3_bin[2], true);
    new tk::dnn::Shortcut(&net,bn2);
    last = new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    new tk::dnn::Conv2d(&net,256,3,3,1,1,1,1,encoder_layer3_bin[3],true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    new tk::dnn::Conv2d(&net,256,3,3,1,1,1,1,encoder_layer3_bin[4],true);
    new tk::dnn::Shortcut(&net,last);
    last = new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    features.push_back(last);
    ...
    //layer4
    new tk::dnn::Conv2d(&net,512,3,3,2,2,1,1,encoder_layer4_bin[0],true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    bn2 = new tk::dnn::Conv2d(&net,512,3,3,1,1,1,1,encoder_layer4_bin[1],true);
    new tk::dnn::Route(&net,&last,1);
    new tk::dnn::Conv2d(&net,512,1,1,2,2,0,0,encoder_layer4_bin[2], true);
    new tk::dnn::Shortcut(&net,bn2);
    last = new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    new tk::dnn::Conv2d(&net,512,3,3,1,1,1,1,encoder_layer4_bin[3],true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    new tk::dnn::Conv2d(&net,512,3,3,1,1,1,1,encoder_layer4_bin[4],true);
    new tk::dnn::Shortcut(&net,last);
    last = new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
    features.push_back(last);

   /* for(int i=0;i<5;i=i+3){
        std::cout<<encoder_layer4_bin[i]<<std::endl;
        new tk::dnn::Conv2d(&net,512,3,3,2,2,1,1,encoder_layer4_bin[i], true);
        new tk::dnn::Activation(&net,CUDNN_ACTIVATION_RELU);
        std::cout<<encoder_layer4_bin[i+1]<<std::endl;
        tk::dnn::Layer* bn2 = new tk::dnn::Conv2d(&net,512,3,3,1,1,1,1,encoder_layer4_bin[i+1], true);
        if(i == 0){
            new tk::dnn::Route(&net,&last,1);
            std::cout<<encoder_layer4_bin[i+2]<<std::endl;
    ...
    //last = new tk::dnn::Dense(&net,1000,encoder_fc_bin);
    ...
    std::cout<<decoder_layer_bin[0]<<std::endl;
    new tk::dnn::Conv2d(&net,256,3,3,1,1,0,0,decoder_layer_bin[0], false,false,256, true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_ELU);
    new tk::dnn::Upsample(&net,2);
    new tk::dnn::Route(&net,&features[3],1);
    new tk::dnn::ReflectionPAD2D(&net,1);
    std::cout<<decoder_layer_bin[1]<<std::endl;
    new tk::dnn::Conv2d(&net,256,3,3,1,1,0,0,decoder_layer_bin[1], false,false,256,true);

    new tk::dnn::ReflectionPAD2D(&net,1);
    new tk::dnn::Conv2d(&net,128,3,3,1,1,0,0,decoder_layer_bin[2], false,false,128,true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_ELU);
    new tk::dnn::Upsample(&net,2);
    new tk::dnn::Route(&net,&features[2],1);
    new tk::dnn::ReflectionPAD2D(&net,1);
    new tk::dnn::Conv2d(&net,128,3,3,1,1,0,0,decoder_layer_bin[3], false,false,128,true);
    last = new tk::dnn::Activation(&net,CUDNN_ACTIVATION_ELU);
    depth_conv_features.push_back(last);

    new tk::dnn::ReflectionPAD2D(&net,1);
    new tk::dnn::Conv2d(&net,64,3,3,1,1,0,0,decoder_layer_bin[4],false,false,64, true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_ELU);
    new tk::dnn::Upsample(&net,2);
    new tk::dnn::Route(&net,&features[1],1);
    new tk::dnn::ReflectionPAD2D(&net,1);
    new tk::dnn::Conv2d(&net,64,3,3,1,1,0,0,decoder_layer_bin[5], false,false,64, true);
    last = new tk::dnn::Activation(&net,CUDNN_ACTIVATION_ELU);
    depth_conv_features.push_back(last);

    new tk::dnn::ReflectionPAD2D(&net,1);
    new tk::dnn::Conv2d(&net,32,3,3,1,1,0,0,decoder_layer_bin[6], false,false,32, true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_ELU);
    new tk::dnn::Upsample(&net,2);
    new tk::dnn::Route(&net,&features[0],1);
    new tk::dnn::ReflectionPAD2D(&net,1);
    new tk::dnn::Conv2d(&net,32,3,3,1,1,0,0,decoder_layer_bin[7], false,false,32,true);
    last = new tk::dnn::Activation(&net,CUDNN_ACTIVATION_ELU);
    depth_conv_features.push_back(last);

    new tk::dnn::ReflectionPAD2D(&net,1);
    new tk::dnn::Conv2d(&net,16,3,3,1,1,0,0,decoder_layer_bin[8], false,false,16,true);
    new tk::dnn::Activation(&net,CUDNN_ACTIVATION_ELU);
    new tk::dnn::Upsample(&net,2);
    new tk::dnn::ReflectionPAD2D(&net,1);
    new tk::dnn::Conv2d(&net,16,3,3,1,1,0,0,decoder_layer_bin[9], false, false,16, true);
    last = new tk::dnn::Activation(&net,CUDNN_ACTIVATION_ELU);
    depth_conv_features.push_back(last);
